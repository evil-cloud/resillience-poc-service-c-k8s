...
helm.sh/chart: {{ include "service-c.chart" . }}
{{ include "service-c.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "service-c.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "service-c.fullname" .) .Values.serviceAccount.name }}
{{- else }}
